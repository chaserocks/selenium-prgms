...
public class DatdrivenTesting2 {
	...
	{
		FileInputStream f=new FileInputStream("E:\\June18Batch\\SeleniumWebdriver\\src\\com\\qedge\\excelfiles\\registration.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\June18Batch\\SeleniumWebdriver\\src\\com\\qedge\\resultexcelfiles\\registration.xlsx");
		wb.write(f1);
		f1.close();
	}
